...
export const translations = {
  en: {
    translation: {
      ...
      install: {
        ...
        description: "Add Breedle to Home Screen to play it easily!",
  ...
  fr: {
    translation: {
      ...
      welldone: "Bien joué !",
      unknownBreed: "Pays inconnu !",
      copy: "Résultat copié !",
      showBreed: "🗺️ Afficher la carte !",
      ...
      install: {
        ...
        description:
          "Ajouter Breedle sur l'écran d'accueil pour le retrouver plus facilement !",
        instructionTitle: "Instructions :",
        instructionActionOk: "OK",
  ...
  es: {
    translation: {
      ...
      welldone: "Bien hecho !",
      unknownBreed: "País desconocido !",
      copy: "Resultado copiado !",
      showBreed: "🗺️ mostrar mapa !",
  ...
  eu: {
    translation: {
      ...
      welldone: "Ongi egina !",
      unknownBreed: "Estatu ezezaguna !",
      copy: "Emaitzak arbelean kopiatuta !",
      showBreed: "🗺️ Erakutsi mapan !",
  ...
  hu: {
    translation: {
      ...
      showOnGoogleMaps: "👀 Google Maps-en",
      welldone: "Szép munka!",
      unknownBreed: "Ismeretlen ország!",
      breedDuplication: "Már tippelted ezt az országot!",
      copy: "Eredmény kimásolva vágólapra",
      showBreed: "🗺️ Mutasd a térképet!",
      ...
      install: {
        ...
        description:
          "Add hozzá a Breedle a Kezdőképernyőhöz, hogy egyszerűbben játszhass!",
        instructionTitle: "In",
        instructionActionOk: "OK",
  ...
  nl: {
    translation: {
      ...
      install: {
        ...
        description:
          "Voeg Breedle toe aan je beginscherm om het makkelijk te spelen!",
  ...
  pl: {
    translation: {
      ...
      welldone: "Gratulacje!",
      unknownBreed: "Nieznane państwo!",
      copy: "Skopiowano wyniki do schowka",
      showBreed: "🗺️ Pokaż mapę!",
      ...
      install: {
        ...
        description: "Dodaj Breedle do ekranu głównego żeby grać łatwiej!",
  ...
  pt: {
    translation: {
      ...
      welldone: "Parabéns!",
      unknownBreed: "País desconhecido!",
      ...
      install: {
        ...
        description:
          "Adicione Breedle a sua página inicial para jogar mais facilmente!",
  ...
  de: {
    translation: {
      ...
      welldone: "Sehr gut!",
      unknownBreed: "Unbekanntes Land!",
      copy: "Ergebnis in Zwischenablage kopiert!",
      showBreed: "🗺️ Karte zeigen!",
      ...
      install: {
        ...
        description:
          "Breedle zum Startbildschirm hinzufügen um einfacher zu spielen!",
  ...
  ja: {
    translation: {
      ...
      install: {
        ...
        description: "ホーム画面にBreedleを追加してプレイしやすくしましょう！",
  ...
  co: {
    translation: {
      ...
      unknownBreed: "Paese scunnisciutu !",
      copy: "Risultati cupiati in u preme’papei",
      showBreed: "🗺️ Affissà a cartugrafia !",
      ...
      install: {
        ...
        description:
          "Aghjunghje Breedle à u screnu d’accolta per ghjucà più prestu !",
